...
class contanctdetails extends Component {
    state = {  }
    render() { 
                ...
                <form className={classes.form} Validate onSubmit={this.handleSubmit}>
                  ...
                  >
                    ...
                    <Grid container spacing={4} className={classes.iconsButton}>
                      <Grid item xs={12}>
                        <label style={{color :"rgba(129, 134, 154, 0.86)", fontWeight : "400", fontSize : "24px"}}>Firstname</label>
                        <TextField
                      ...
                      <Grid item xs={12}>
                      <label style={{color :"rgba(129, 134, 154, 0.86)", fontWeight : "400", fontSize : "24px"}}>Lastname</label>
                        <TextField
                          className={classes.inputField}
                          variant="outlined"
                          margin="normal"
                    ...
                    <Grid item xs={6}>
                      <label style={{color :"rgba(129, 134, 154, 0.86)", fontWeight : "400", fontSize : "24px"}}>Gender</label>
                        <TextField
                          className={classes.inputField}
                          variant="outlined"
                          margin="normal"
                      ...
                      <Grid item xs={6}>
                      <label style={{color :"rgba(129, 134, 154, 0.86)", fontWeight : "400", fontSize : "24px"}}>Date of birth</label>
                        <TextField
                          className={classes.inputField}
                          variant="outlined"
                          margin="normal"
